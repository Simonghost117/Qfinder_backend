...
export const registerSchema = z.object({
    ...
    identificacion_usuario: z.string()
        .regex(/^[1-9]\d{6,10}$/, { message: "La identificación debe tener entre 7 y 11 dígitos numéricos y no puede comenzar con cero",
  }),
    ...
    contrasena_usuario: z.string()
        ...
        .regex(/^(?=.*[A-Z])(?=.*[!@#$%^&*()_+{}\[\]:;<>,.?~\\/-]).+$/, { message: "La contraseña debe contener al menos una letra mayúscula y un carácter especial" }), 
